...
let apiList = ["http://az-jp.rosemoe.cyou:80/", "http://rsmapi2.donglin.lv:9987/", "https://rsmapi.inko.lv:443/", "https://rsmapi.donglin.lv:443/", "http://whut-device.rosemoe.cyou:12000/"]
...
function apiRequest() {
    if (apiIndex < apiList.length) {
        ...
        if (encodeURIComponent(optionBox.value) == "%E5%85%A8%E9%83%A8%E9%A2%98%E5%BA%93")
            apiUrl = apiList[apiIndex] + 'v1/problem_bank/query?problem_set=all&content_query=' + encodeURIComponent(searchBox.value);
        else
            apiUrl = apiList[apiIndex] + 'v1/problem_bank/query?problem_set=' + encodeURIComponent(optionBox.value) + '&content_query=' + encodeURIComponent(searchBox.value);
        ...
        alert("API 请求失败！请先使用在线文档 https://kdocs.cn/l/cuOyPm6HYfYz 等待开发者维护。");
    }
}
